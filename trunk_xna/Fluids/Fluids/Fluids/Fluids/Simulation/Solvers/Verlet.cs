...
namespace Astro
{
   ...
   public sealed class Verlet : Solver
   {
      ...
      public override void Solve(ref Vector2 position, ref Vector2 positionOld, ref Vector2 velocity, Vector2 acceleration, float timeStep)
      {
         ...
         Vector2.Multiply(ref acceleration, timeStep * timeStep, out acceleration);
         Vector2.Subtract(ref position, ref positionOld, out t);
         Vector2.Multiply(ref t, 1.0f - Damping, out t);
         ...
         Vector2.Subtract(ref position, ref positionOld, out t);
         Vector2.Divide(ref t, timeStep, out velocity);
      }
