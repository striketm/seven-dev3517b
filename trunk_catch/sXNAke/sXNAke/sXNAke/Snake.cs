...
namespace sXNAke
{
    class Snake : GameObject
    {
        ...
        public void Grow()
        {
            ...
            Body body = new Body(textureBody, bodies.Last().actual_direction);
        

            switch (bodies.Last().actual_direction)
            {
                case Direction.LEFT:
                    body.Position = new Vector2(
                        bodies.Last().CollisionRect.X + bodies.Last().CollisionRect.Width,
                        bodies.Last().Position.Y);
                    break;
                ...
                case Direction.UP:
                    body.Position = new Vector2(
                        bodies.Last().Position.X,
                        bodies.Last().CollisionRect.Y + bodies.Last().CollisionRect.Height);
                    break;
                case Direction.DOWN:
                    body.Position = new Vector2(
                        bodies.Last().Position.X,
            ...
            */
            if (player == "1")
            {
                ...
                //actual_direction != Direction.UP))
                {
                    ...
                    if (
                           Game1.keyboardState.IsKeyDown(Keys.Left) &&
